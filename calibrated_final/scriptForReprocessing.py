...
make_mfs_images = False                  # generate mfs (per spw) images
make_cont_images = False                 # generate aggregate continuum images
...
maxproductsize = 5350.                   # for mitigation; in GB
maxcubesize = 1040.                       # for mitigation; in GB
maxcubelimit = 1060.                      # for mitigation; in GB
...
if args.image:
    if not glob.glob("../"+args.image):
        ...
        try:
            ...
            # exist_ok keyword doesn't exist in this version of python?
            print(ex)
    else:
    ...
    # Notify the user if selfcal was performed on the data
    if glob.glob('../caltables/sc_workdir_*') or glob.glob('../caltables/*selfcal.json'):
        print('Selfcal was performed on this data!')
        print('Note: The image products will have the default "regcal" filenames, but this is fine. The selfcal corrections were performed correctly.')
