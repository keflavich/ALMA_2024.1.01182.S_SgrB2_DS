#!/usr/bin/env python
"""
Image cube 3: SgrB2S_DS1-5 SPW 29
...
temp_vis = sorted(glob.glob('/orange/adamginsburg/sgrb2/2024.1.01182.S/calibrated_final/temp_line/uid*_DS15_spw29_line.ms'))
...
imagename = 'oussid.SgrB2_SgrB2S_DS1-5_sci.spw29.cube.I'

# Imaging parameters
print("="*80)
print(f"IMAGING: SgrB2S_DS1-5 SPW 29")
