#!/usr/bin/env python
"""
Image cube 2: SgrB2S_DS1-5 SPW 27
...
temp_vis = sorted(glob.glob('/orange/adamginsburg/sgrb2/2024.1.01182.S/calibrated_final/temp_line/uid*_DS15_spw27_line.ms'))
...
imagename = 'oussid.SgrB2_SgrB2S_DS1-5_sci.spw27.cube.I'

# Imaging parameters
print("="*80)
print(f"IMAGING: SgrB2S_DS1-5 SPW 27")
